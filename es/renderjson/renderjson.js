...
(module || {}).exports = renderjson = (function () {
    ...
    var A = function A(txt, classname, callback) {
        ...
        a.href = '#';
        a.onclick = function (e) { callback(); if (e)
    ...
    function _renderjson(json, indent, dont_indent, show_level, max_string, sort_objects) {
        ...
        var disclosure = function (open, placeholder, close, type, builder) {
            ...
            var show = function () {
                if (!content)
                    append(empty.parentNode, content = prepend(builder(), A(renderjson.hide, "disclosure", function () {
        ...
        if (json.constructor == Array) {
            ...
            return disclosure("[", " ... ", "]", "array", function () {
                ...
                for (var i = 0; i < json.length; i++)
                    append(as, _renderjson(json[i], indent + "    ", false, show_level - 1, max_string, sort_objects), i != json.length - 1 ? themetext("syntax", ",") : [], text("\n"));
