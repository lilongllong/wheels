...
function inorder(tree) {
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                if (!(tree && tree.left)) return [3 /*break*/, 2];
                return [5 /*yield**/, __values(inorder(tree.left))];
            case 1:
                _a.sent();
                _a.label = 2;
            case 2: return [4 /*yield*/, tree.text];
            case 3:
                _a.sent();
                if (!(tree && tree.right)) return [3 /*break*/, 5];
                return [5 /*yield**/, __values(inorder(tree.right))];
            case 4:
                _a.sent();
                _a.label = 5;
...
var tree = constructTree([[['a'], 'b', ['c']], 'd', [['e'], 'f', ['g']]]);
console.log(tree);
var result = [];
var generator = inorder(tree);
for (var _i = 0, generator_1 = generator; _i < generator_1.length; _i++) {
    var item = generator_1[_i];
    result.push(item);
}
console.log(result);
